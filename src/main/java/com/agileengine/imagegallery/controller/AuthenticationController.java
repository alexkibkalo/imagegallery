...
import com.agileengine.imagegallery.service.authorization.AuthorizationService;
...
@RequestMapping(path = "interview.agileengine.com/auth", produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
